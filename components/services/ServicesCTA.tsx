...
export default function ServicesCTA() {
  return (
    <section className="relative overflow-hidden bg-brand-900 py-16 text-surface-50 lg:py-20">
      ...
      />
      <div
        className="absolute -right-20 top-10 h-48 w-48 rounded-full bg-accent-500/10 blur-3xl"
        aria-hidden
      />
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <h2 className="font-heading text-3xl font-bold sm:text-4xl">
          Start Your Construction Project with the Right Service
        </h2>
        <p className="mx-auto mt-4 max-w-2xl font-body text-base leading-relaxed text-brand-100">
          From turnkey construction and grey structure to renovation, design,
          finishing, plumbing, painting, flooring, solar, and CCTV
          installation, we provide construction services that help you complete
