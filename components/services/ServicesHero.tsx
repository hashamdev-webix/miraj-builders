        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="font-body text-xs font-semibold uppercase tracking-[0.2em] text-accent-500">
              Complete Design, Build &amp; Finishing Solutions
            </span>
          </div>

          <h1 className="mt-5 font-heading text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl">
            Construction Services in Pakistan{" "}
            <span className="text-accent-500">
              for Homes, Renovation &amp; Turnkey Projects
            </span>
          </h1>

          <div className="mt-6 max-w-xl space-y-4">
            <p className="font-body text-base leading-relaxed text-brand-100">
              We provide complete construction services for residential and
              commercial projects, from design and planning to grey structure,
              finishing, renovation, installation, and final handover. Whether
              you need a full turnkey construction solution or a specific
              service like architectural design, renovation, plumbing,
              painting, flooring, solar panels, or CCTV installation, our team
              can manage the work professionally.
            </p>
            <p className="font-body text-base leading-relaxed text-brand-100">
              Our services are designed for clients who want reliable planning,
              clear cost guidance, skilled workmanship, and smooth project
              execution under one experienced team.
            </p>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative aspect-4/3 overflow-hidden rounded-card bg-brand-700 shadow-card">
            <Image
              ...
              alt="Modern residential construction project representing Miraj Builders services in Pakistan"
              fill
              priority
            ...
            <div className="absolute bottom-5 left-5 rounded-card border border-surface-50/15 bg-brand-900/85 px-5 py-4 backdrop-blur-sm">
              ...
              <p className="mt-1 font-body text-xs text-brand-100">
                Planning, construction, finishing, and handover
              </p>
            </div>
          </div>
        </div>
