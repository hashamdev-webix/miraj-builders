...
export default function ComingSoon({
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-5rem)] items-center justify-center overflow-hidden bg-brand-900 px-6 py-20 text-center text-surface-50">
      ...
      <section className="relative z-10 mx-auto w-full max-w-4xl">
        ...
        <h1 className="mx-auto mt-10 max-w-4xl font-heading text-4xl font-bold tracking-tight text-surface-50 sm:text-5xl lg:text-6xl">
          {title}
        </h1>
        ...
        <p className="mt-8 font-body text-sm text-surface-50/70">
          ...
          <span className="mx-2 text-accent-500">•</span> {SITE.email}
        </p>
